...
legend("topright", legend=names(data)[7:9], lty=1, col=c(1, "red", "blue"), bty="n")
# FOURTH PLOT
with(data, plot(DateTime, Global_reactive_power, type="l", xlab="datetime", ylab=names(data)[4]))
dev.off()
